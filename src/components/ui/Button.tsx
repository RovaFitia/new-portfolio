...
const Button = ({
    ...
    const base =
        "border transition-colors duration-300 ease-in-out rounded-full cursor-pointer flex items-center justify-center gap-2 text-nowrap outline-none";
    const variants = {
    ...
    const classes: string = [sizes[size], base, variants[variant], className]
        .filter(Boolean)
        .join(" ");
