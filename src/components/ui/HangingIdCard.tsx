    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* ID Card */}
                <div className="relative w-58 overflow-hidden shadow-2xl border border-zinc-200/80 bg-white rounded-[12px] pointer-events-none -mt-4">
                    {/* Punched Slot Hole for Lanyard Clip */}
                    <div className="flex justify-center pt-2.5 pb-1 bg-zinc-500/10 border-b border-zinc-200/80">
                        <div className="w-8 h-2.5 rounded-full bg-zinc-950 border border-zinc-400/50 shadow-inner flex items-center justify-center">
                            <div className="w-6 h-1 rounded-full bg-white opacity-90" />
                        </div>
                    </div>
                    ...
                    {children ?? (
                        <div className="flex flex-col h-full">
                            {/* Card Header Banner */}
                            <div
                                className="flex flex-col items-center justify-center gap-2 relative h-50"
                                style={{
                            ...
                            >
                                ...
                                {!profile && (
                                    <div className="flex h-24 w-24 items-center justify-center rounded-full bg-white/20 backdrop-blur-md mt-1 border border-white/30 shadow-md">
                                        <svg
                            ...
                            {/* Card Body */}
                            <div className="bg-zinc-500/10 px-4 py-4 flex flex-col items-center gap-1.5 flex-1">
                                ...
                                <div className="my-1.5 w-full border-t border-line" />
                                ...
                                {/* Status badge */}
                                <div className="mt-1 px-3 py-0.5 rounded-full text-[9px] font-haffer-r text-text uppercase tracking-widest bg-primary-400">
                                    ACTIVE
                                </div>
                            </div>
                        </div>
            ...
            {/* Drag hint */}
            <p className="mt-8 text-[11px] text-dark font-haffer-md select-none pointer-events-none">
